...
public class PersistStateMachineHandler extends LifecycleObjectSupport {
     ...
     */
    public boolean handleEventWithState(Message<OrderStatusChangeEvent> event, Order o) {
        stateMachine.stop();
        ...
        for (StateMachineAccess<OrderStatus, OrderStatusChangeEvent> a : withAllRegions) {
            a.resetStateMachine(new DefaultStateMachineContext<>(o.getOrderStatus(), null, null, null));
        }
        stateMachine.start();
